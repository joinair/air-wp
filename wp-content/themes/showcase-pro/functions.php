...
function get_feature_children() {
				...
				foreach($childs as $child){
					...
					$other_air_features.='<div class="wpb_column vc_column_container vc_col-sm-4" style="padding-top: 20px;"><p class="p1" style="text-align: center;"><a href="'.$child_link.'"><b><img class="aligncenter wp-image-10144" src="'.$child_image.'" width="120" height="120" /></b></a></p>
