...
if ( !class_exists( 'NelioABCssAltExpProgressPage' ) ) {
	...
	class NelioABCssAltExpProgressPage extends NelioABAltExpProgressPage {
		...
		public function do_render() {
			parent::do_render(); ?>
			<div id="preview-dialog-modal" title="<?php _e( 'CSS', 'nelio-ab-testing' ); ?>" style="display:none;">
			...
			<script type="text/javascript">
				...
				jQuery(document).ready(function() {
					$nelioabPreviewDialog = jQuery('#preview-dialog-modal').dialog({
						...
						buttons : [
							{
								text: "<?php echo esc_html( __( 'Close', 'nelio-ab-testing' ) ); ?>",
								click: function() {
		...
		protected function print_experiment_details_title() {
			_e( 'Details of the CSS Experiment', 'nelio-ab-testing' );
		}
		...
		protected function print_winner_info() {
			...
			if ( $exp->get_status() == NelioABExperiment::STATUS_RUNNING ) {
				if ( $the_winner == 0 )
					echo '<p><b>' . __( 'Right now, no CSS alternative is helping to improve your site.', 'nelio-ab-testing' ) . '</b></p>';
				if ( $the_winner > 0 )
					echo '<p><b>' . sprintf( __( 'Right now, the alternative %s is better than none to improve your site.', 'nelio-ab-testing' ), $the_winner ) . '</b></p>';
			}
			else {
				if ( $the_winner == 0 )
					echo '<p><b>' . __( 'No CSS alternative helped to improve your site.', 'nelio-ab-testing' ) . '</b></p>';
				if ( $the_winner > 0 )
					echo '<p><b>' . sprintf( __( 'CSS alternative %s was better than none to improve your site.', 'nelio-ab-testing' ), $the_winner ) . '</b></p>';
			}
		}
...
HTML;
		...
		protected function print_the_real_alternatives() {
			...
			$view_label             = __( 'View', 'nelio-ab-testing' );
