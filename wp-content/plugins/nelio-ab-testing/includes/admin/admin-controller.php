	...
	class NelioABAdminController {
		...
		public function admin_footer_text( $footer_text ) {
			...
			if ( ! get_option( 'nelioab_admin_footer_text_rated' ) ) {
				...
				$footer_text = __( 'Thank you for using <a href="https://nelioabtesting.com/?plugin=footer-notice" target="_blank">Nelio A/B Testing.</a>', 'nelio-ab-testing' );
			}
		...
		public function add_plugin_action_links( $links, $file ) {
			if ( $file == plugin_basename( NELIOAB_PLUGIN_ID ) && is_plugin_active( $file ) ) {
				...
				$dashboard_link = sprintf( $dashboard_link,
						__( 'Clean and Deactivate', 'nelio-ab-testing' ),
						__( 'Warning!', 'nelio-ab-testing' ),
						__( 'You are about to clean all your A/B testing data. This operation cannot be undone. Are you sure you want to continue?', 'nelio-ab-testing' ),
						wp_nonce_url(
		...
		public function print_alternative_comments( $post ) {
			...
			<input name="nelioab_hide_discussion" type="checkbox" <?php
					checked( $checked );
				?> /> <?php
			_e( 'Hide original discussion in this alternative.', 'nelio-ab-testing' );
		}
			...
			<div id="submitdiv"><?php
				...
				<div class="submitbox" id="submitpost">
					...
					<div style="margin:0.8em 0.2em 0.8em 0.2em;">
						<b><?php _e( 'Go back to...', 'nelio-ab-testing' ); ?></b>
						<ul style="margin-left:1.5em;">
							...
							switch( $exp_status ){
								...
								case NelioABExperiment::STATUS_READY:
									?><li><a href="<?php echo $url . '&action=edit&ctab=tab-alts&id=' . $exp_id .
										'&exp_type=' . NelioABExperiment::PAGE_OR_POST_ALT_EXP; ?>"><?php
											_e( 'Editing this experiment', 'nelio-ab-testing' ); ?></a></li><?php
									break;
								...
								case NelioABExperiment::STATUS_FINISHED:
									...
									'&exp_type=' . NelioABExperiment::PAGE_OR_POST_ALT_EXP; ?>"><?php
										_e( 'The results of the related experiment', 'nelio-ab-testing' ); ?></a></li><?php
									break;
							...
							?>
							<li><a href="<?php echo $url; ?>"><?php _e( 'My list of experiments', 'nelio-ab-testing' ); ?></a></li>
							<?php if( $exp_status == NelioABExperiment::STATUS_RUNNING ) { ?>
								<li><a href="<?php echo admin_url( 'admin.php?page=nelioab-dashboard' ); ?>"><?php _e( 'The Dashboard', 'nelio-ab-testing' ); ?></a></li>
							<?php } ?>
						</ul>
					</div>
				</div>
