...
if ( !class_exists( 'NelioABProductSummaryAltExpEditionPage' ) ) {
	...
	class NelioABProductSummaryAltExpEditionPage extends NelioABAltExpPage {
		...
		protected function get_basic_info_elements() {
			$ori_label = __( 'Original Product', 'nelio-ab-testing' );
		...
		protected function print_ori_field() {
			...
			<span class="description" style="display:block;"><?php
				_e( 'You will create alternative summaries (name, featured image, and description) for this product.', 'nelio-ab-testing' );
			?></span><?php
		}
		...
		protected function print_alternatives() { ?>
			<h2><?php
				printf( '<a onClick="javascript:%1$s" class="add-new-h2" href="javascript:;">%2$s</a>',
					...
					__( 'New Product Summary', 'nelio-ab-testing' )
				);
			?></h2><?php
	...
	class NelioABProductSummaryAlternativesTable extends NelioABAlternativesTable {
		...
		public function extra_tablenav( $which ) {
			if ( 'top' == $which ){
				$text = __( 'Please, <b>add one or more</b> alternative product summaries.', 'nelio-ab-testing' );
				echo $text;
			}
		}
			...
			<fieldset style="padding:1em;">
				...
				<div>
					<div class="headline_image_holder">
						...
						<div class="headline_image_hover"><?php _e( 'Change', 'nelio-ab-testing' ); ?></div>
					</div>
					<div style="width:60%;display:inline-block;vertical-align:top;">
						<span class="input-text-wrap">
							<div class="nelio-sect"><label style="margin:0px;">
								<input type="text" class="headline_title ptitle" value="" placeholder="<?php echo esc_html( __( 'Title', 'nelio-ab-testing' ) ); ?>" />
							</label></div>
							<textarea class="headline_excerpt" placeholder="<?php echo __( 'Original Description', 'nelio-ab-testing' ); ?>"></textarea>
						</span>
					</div>
				</div>
			</fieldset>
