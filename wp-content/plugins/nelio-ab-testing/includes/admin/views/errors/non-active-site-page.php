	...
	class NelioABNonActiveSitePage extends NelioABAdminAjaxPage {
		...
		protected function do_render() {
			...
			echo sprintf( "<p style=\"$style\">%s</p>\n",
					__( 'Appearently, your account information is properly configured, but this site has not been activated yet. In order to create, manage, and execute experiments, you have to activate the site in your account.', 'nelio-ab-testing' )
				);

			echo sprintf( "<p style=\"$style\">%s</p>\n",
					__( 'Please, go to the «My Account» page and make sure you activate this site.', 'nelio-ab-testing' )
				);
