	...
	class NelioABDeactivatedUserPage extends NelioABAdminAjaxPage {
		...
		protected function do_render() {
			...
			echo sprintf( "<p style=\"$style\">%s</p>\n",
					__( 'The user account has been deactivated. Normally, this occurs once you unsubscribed from our Nelio A/B Testing service. If you want to use the service, you may want to consider subscribing to one of our packages again.', 'nelio-ab-testing' )
				);

			echo sprintf( "<p style=\"$style\">%s</p>\n",
					__( 'Please, go to the settings page and check your subscription details.', 'nelio-ab-testing' )
				);
