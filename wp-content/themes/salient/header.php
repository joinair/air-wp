...
<link rel="icon" type="image/x-icon" href="https://www.joinair.com/wp-content/uploads/2016/05/favicon.png" />
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col span_3">
					...
					<a id="logo" style="margin-top:0px;" href="<?php echo home_url(); ?>" <?php echo $logo_class; ?>>
				...
				<div class="col span_9 col_last">
					...
					<nav>
						...
						<ul class="sf-menu" style="margin-top:1px;">	
							<?php 
				...
				<div style="float: right !important;">
					...
					<nav>
						<ul class="sign-in-menu" style="padding-bottom: 5px !important;">
							<a href="https://app.joinair.com/login" class="" style="">Log in</a>
							<a href="https://app.joinair.com/signup" class="sign-in-menu-button" style="">Sign up for free</a>
						</ul>
					</nav>
				</div>
