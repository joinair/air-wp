		...
		public function render() { ?>
			...
			<div class="wrap">
				...
				<div id="ajax-loader" style="text-align:center;<?php echo $is_data_pending_loader; ?>">
					...
					<h2 style="color:#555;margin:0;padding:0;"><?php _e( 'Loading...', 'nelio-ab-testing' ); ?></h2>
					<p id="ajax-loader-label1" style="color:#777;margin:0;padding:0;"><?php _e( 'Please, wait a moment.', 'nelio-ab-testing' ); ?></p>
					<p id="ajax-loader-label2" style="color:#777;margin:0;padding:0;display:none;"><?php _e( 'Keep waiting...', 'nelio-ab-testing' ); ?></p>
					<p id="ajax-loader-label3" style="color:#777;margin:0;padding:0;display:none;"><?php _e( 'Internet connection seems very slow.', 'nelio-ab-testing' ); ?></p>
				</div>
