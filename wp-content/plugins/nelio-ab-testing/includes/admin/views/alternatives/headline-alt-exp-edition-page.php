...
if ( !class_exists( 'NelioABHeadlineAltExpEditionPage' ) ) {
	...
	class NelioABHeadlineAltExpEditionPage extends NelioABAltExpPage {
		...
		protected function print_ori_field() {
			...
			<span class="description" style="display:block;"><?php
				_e( 'You will create alternative headlines (title, featured image, and excerpt) for this post.', 'nelio-ab-testing' );
			?></span><?php
		}
		...
		protected function print_alternatives() { ?>
			<h2><?php
				printf( '<a onClick="javascript:%1$s" class="add-new-h2" href="javascript:;">%2$s</a>',
					...
					__( 'New Headline', 'nelio-ab-testing' )
				);
			?></h2><?php
	...
	class NelioABHeadlineAlternativesTable extends NelioABAlternativesTable {
		...
		public function extra_tablenav( $which ) {
			if ( 'top' == $which ){
				$text = __( 'Please, <b>add one or more</b> headline alternatives.', 'nelio-ab-testing' );
				echo $text;
			}
		}
				...
				<div>
					...
					<div style="width:60%;display:inline-block;vertical-align:top;">
						<span class="input-text-wrap">
							...
							<textarea class="headline_excerpt" placeholder="<?php echo __( 'Original Excerpt', 'nelio-ab-testing' ); ?>"></textarea>
						</span>
					</div>
				</div>
			</fieldset>
