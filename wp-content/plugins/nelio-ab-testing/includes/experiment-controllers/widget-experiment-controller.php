				...
				<div id="nelioab-edit-alt-widgets" class="widgets-holder-wrap" style="border: 1px solid #e5e5e5;-webkit-box-shadow: 0 1px 1px rgba(0,0,0,.04);box-shadow: 0 1px 1px rgba(0,0,0,.04);">
					<div class="widgets-sortables ui-sortable">
						<div class="sidebar-name" style="padding:0.2em 1em;background-color:<?php echo $colorscheme['focus']; ?>;">
							...
							<h3 style="color:<?php echo $colorscheme['foreground']; ?>;"><?php _e( 'Alternative Widget Set', 'nelio-ab-testing' ); ?></h3>
						</div>
					</div>

					<div class="content" style="padding:0em 1em 1em 1em;">
						<p><?php _e( 'Use the following button to duplicate the widgets you\'re currently using in your site.', 'nelio-ab-testing' ); ?></p>
						<a class="button button-primary" id="duplicate-widgets"><?php _e( 'Duplicate Widgets', 'nelio-ab-testing' ); ?></a>
						<span class="spinner" style="float:none;"></span>
						<p><strong><?php _e( 'Go back to...', 'nelio-ab-testing' ); ?></strong></p>
						<ul style="margin-left:1.5em;">
							<?php if ( isset( $_GET['back_to_edit'] ) ):
								...
								?>
								<li><a href="<?php echo $url; ?>"><?php _e( 'Editing this experiment', 'nelio-ab-testing' ); ?></a></li>
							<?php else:
								...
								?>
								<li><a href="<?php echo $url; ?>"><?php _e( 'The results of the related experiment', 'nelio-ab-testing' ); ?></a></li>
							<?php endif; ?>
